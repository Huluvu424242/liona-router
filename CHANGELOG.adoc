...
* https://github.com/Huluvu424242/liona-router/issues/10[issue 10] add statistic module
...
* https://github.com/Huluvu424242/liona-router/issues/7[issue 7] cleanup realisiert
...
* https://github.com/Huluvu424242/liona-router/issues/3[issue 3] support of uuid
* https://github.com/Huluvu424242/liona-router/issues/4[issue 4] addCORSHeader function added
